      ...
      <div className="container">
        ...
        <div className="row text-center">
          ...
          <div className="col-md-4">
            ...
            >
              <path
                d="M8 7.9818C9.66439 6.30907 13.8254 9.23635 8 13C2.17465 9.23635 6.33561 6.30907 8 7.9818Z"
                fill="black"
              />
              <path
                d="M3.75 0C3.43524 0 3.13885 0.148194 2.95 0.4L0.1 4.2C0.0350889 4.28655 0 4.39182 0 4.5V15C0 15.5523 0.447715 16 1 16H15C15.5523 16 16 15.5523 16 15V4.5C16 4.39182 15.9649 4.28655 15.9 4.2L13.05 0.4C12.8611 0.148194 12.5648 0 12.25 0H3.75ZM3.75 1H7.5V4H1.5L3.75 1ZM8.5 4V1H12.25L14.5 4H8.5ZM15 5V15H1V5H15Z"
                fill="black"
              />
            </svg>
            <p className="text-muted">
            ...
            <p className="text-muted">
              Персонализирана изработка според предпочнитанията Ви.
            </p>
          </div>
          <div className="col-md-4">
            <div className="icon-container">
